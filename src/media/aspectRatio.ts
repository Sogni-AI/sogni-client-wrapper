...
export interface MediaDimensionBounds {
  minDimension: number;
  maxDimension: number;
...
export function validateMediaAspectRatio(
  width: number,
  height: number,
  maxAspectRatio = DEFAULT_MAX_MEDIA_ASPECT_RATIO,
): string | null {
...
export function validateMediaDimensionValue(
  value: number,
  bounds: MediaDimensionBounds,
...
export function validateMediaAspectRatioString(
