    ...
    parameters: {
      ...
      properties: {
        ...
        prompt: {
          type: 'string',
          description:
            'Describe the SUBJECT and ambient environment (for example, a concise ' +
        ...
        dialogues: {
          ...
          items: { type: 'string' },
          description:
            'Per-segment spoken dialogue lines for multiple orbit transitions. Use this ' +
        ...
        sourceImageIndex: {
          type: 'number',
          description:
            'Which result image to orbit around (0-based). If the user picked a ' +
