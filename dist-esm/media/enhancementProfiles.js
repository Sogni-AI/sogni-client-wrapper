...
export const ENHANCE_PROFILES = [
    {
        ...
        profiles: [
            ...
            },
            {
                ...
                prompt: 'professional post-production finish, refined lighting and shadows, clean tonal balance, realistic color grading, subtle contrast and clarity, polished textures, preserve subject identity and composition, increased photorealistic appearance',
            },
            {
                id: 'smartphoneRealism',
                title: 'Smartphone Camera Look',
                prompt: 'realistic smartphone photo look, natural handheld capture, slightly sharpened details, mild HDR highlights and shadows, realistic color and exposure, subtle noise, preserve subject and composition, increased photorealistic appearance',
            },
            {
                id: 'cinematicRealism',
                title: 'Cinematic Realism',
                prompt: 'cinematic realistic look, film-style lighting and contrast, natural depth and shadow shaping, increased photorealistic appearance, subtle color grading, refined highlights, realistic textures, preserve subject identity and composition',
            },
            {
                id: 'flashPhotoRealism',
                title: 'Flash Photo Look',
                prompt: 'direct flash photography look, realistic harsh lighting and shadows, flat exposure with strong highlights, increased photorealistic appearance, slight noise, candid photo feel, preserve subject and scene',
            },
        ],
    },
    {
        ...
        profiles: [
            {
                ...
                prompt: 'refine existing fine details, enhance micro-textures and subtle surface features, improve clarity of small details, polish unfinished areas',
            },
            {
                id: 'enrichDetails',
                title: 'Enrich Scene Details',
                prompt: 'add cohesive, scene-wide detail across foreground and background, enrich environmental textures and materials, enhance lighting, shadows, and depth, increase atmospheric and spatial detail, maintain overall composition and subject integrity',
            },
        ],
    },
    {
        ...
        profiles: [
            {
                ...
                prompt: 'restore and modernize the image, improve clarity and sharpness, repair faded tones, enhance contrast and detail, reduce noise and artifacts, maintain original features and identity',
            },
            {
                id: 'vintageFilmLook',
                title: 'Vintage Look',
                prompt: 'vintage film photo look, aged color response, gentle contrast, subtle film grain, soft highlights, slight fading, mild vignetting, realistic textures, preserve subject and composition',
            },
        ],
    },
];
export function getEnhancementPrompt(categoryId, profileId) {
...
export function getEnhancementStrength(strength) {
    switch (strength) {
        case 'light':
            return 0.15;
        case 'heavy':
...
//# sourceMappingURL=enhancementProfiles.js.map