    ...
    function: {
        ...
        parameters: {
            ...
            properties: {
                ...
                keepOriginalAudio: {
                    type: 'boolean',
                    description: 'When true (default), the audio from the original [startSeconds, endSeconds] window is muxed onto the regenerated visuals so the user keeps the original dialogue/score. When false, the new clip\'s own audio is used (LTX renders fresh audio; Seedance V2V depends on generateAudio). Default: true.',
                },
            },
