...
BATCH VARIATIONS: When numberOfVariations > 1, use Dynamic Prompt syntax to vary motion, camera, or atmosphere while preserving the user's specified elements. Example: "{gentle sway with soft birdsong|dramatic zoom with rolling thunder|slow pan with ambient music}".`,
        ...
        negativePrompt: {
          type: "string",
          description:
            "Optional negative prompt for LTX/Wan image-to-video models. Use only when the user explicitly states what should be avoided; do not use this field for Seedance workflows.",
        },
        duration: {
          type: "number",
          description:
        ...
        numberOfVariations: {
          type: "number",
          description:
            "Number of variations (1-16). Use 1 unless user explicitly requests multiple separate video outputs.",
          minimum: 1,
          maximum: 16,
        },
        aspectRatio: {
